...
class PdfCreation(CreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            pdf.image(r'C:\Users\Vrdella\Desktop\pdf_creation\pdf_creation_project\pdf_creation_app\voni.png', 11, 11,
                      15, 15)
            pdf.set_xy(35, 13)
            pdf.multi_cell(60, 5,
                           txt="3RD FLOOR, 4 D/10, VIJAY TOWERS COLLECTOR OFFICEROAD, Tiruchirappalli, Tamil Nadu, 62000",
                           align='R')
            ...
            pdf.set_xy(120, y)
            pdf.multi_cell(78, 5,
                           'Our offer is valid for 30 days from the date of this quotation and subject to the prior confirmation')
