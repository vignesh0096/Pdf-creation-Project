...
# pdf.set_xy(35,13)
# pdf.multi_cell(60, 5, text="3RD FLOOR, 4 D/10, VIJAY TOWERS COLLECTOR OFFICEROAD, Tiruchirappalli, Tamil Nadu, 62000",align='R')
#
...
# d = {
#     'HSN/SAC' : ['','','','','','','','','','','','','','','',''],
#     'Description' : ['EC4M','EC6M','EC8MF','EC8MF2','EC4M','EC6M','EC8MF','EC8MF2','EC4M','EC6M','EC8MF','EC8MF2','EC4M','EC6M','EC8MF','EC8MF2'],
#     "MRP":[14500,17250,21000,21500,14500,17250,21000,21500,14500,17250,21000,21500,14500,17250,21000,21500],
...
# pdf.rect(120,y,80,10)
# pdf.set_xy(120,y)
# pdf.multi_cell(78,5,'Our offer is valid for 30 days from the date of this quotation and subject to the prior confirmation thereafter')
#
# y = axis(y,pdf)
# pdf.set_font('times','',10)
